...
<template>
    ...
    <Head title="UploadModal" />

    <div>
        <!-- component -->
        <div class="fixed z-10 left-0 top-0 w-full h-full flex bg-black bg-opacity-60">
            <div class="extraOutline p-4 bg-white w-max bg-whtie m-auto rounded-lg">
                <div class="file_upload p-5 relative border-4 border-dotted border-gray-300 rounded-lg" style="width: 450px">
                    ...
                    <div class="input_field flex flex-col w-max mx-auto text-center">
                        ...
                        <div class="title text-indigo-600">or drop files here</div>
                        <Link href="/dashboard" class="mt-10 title text-red-500 uppercase">Close</Link>
                    </div>
                </div>
            </div>
        </div>
